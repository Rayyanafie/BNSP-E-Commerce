                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" placeholder="Enter your username">
                                @error('username')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" placeholder="Enter your address">
                                @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="{{ old('city') }}" placeholder="Enter your city">
                                @error('city')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <!-- PayPal ID -->
                        <div class="row mb-3">
                            <label for="paypal_id" class="col-md-4 col-form-label text-md-end">{{ __('PayPal ID') }}</label>
                            <div class="col-md-6">
                                <input id="paypal_id" type="text" class="form-control @error('paypal_id') is-invalid @enderror" name="paypal_id" value="{{ old('paypal_id') }}" placeholder="Enter your PayPal ID">
                                @error('paypal_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
